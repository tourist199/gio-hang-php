...
<div>
    ...
    <div class="container">
        ...
        <div style="min-height:78vh">
            ...
            <form action="editProduct.php?id=<?php echo $id_product ?>" method="post" enctype="multipart/form-data">
                <label for="name">Name: </label> 
                <input type="text" name="name" id="name" value="<?php echo $product->name?>"> <br><br>

                <label for="price">Price: </label> 
                <input type="number" name="price" id="price" value="<?php echo $product->price?>"> <br><br>

                <label for="category">Category: </label> 
                <select style="display: block !important;" class="form-control" name="category" value="<?php echo $product->category?>">
                ...
                <input type="text" name="desc" id="desc" value="<?php echo $product->desc?>"> <br><br>

                <label for="star">Star: </label> <br>
                <input type="number" min="1" max="5" name="star" id="star" value="<?php echo $product->star?>"> <br><br>
