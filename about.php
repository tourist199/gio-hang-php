                ...
                <div class="col-lg-9">
                    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox" style="height: 350px;">
                            <div class="carousel-item"><img class="d-block img-fluid" src="https://hoanghamobile.com/tin-tuc/wp-content/uploads/2018/02/T2-T%E1%BA%BFt-Sale-t%E1%BB%95ng-fb-Ads-803x420.png" alt="First slide"></div>
                            <div class="carousel-item active"><img class="d-block img-fluid" src="http://www.mobiistar.vn/wp-content/uploads/2015/10/banner800x400.jpg" alt="Second slide"></div>
                    ...
                    <section class="page-section bg-primary text-white mb-0 jumbotron" id="about">
                        <div class="container">
                            ...
                            <div class="text-center mt-4"><a class="btn btn-xl btn-outline-light" href="https://startbootstrap.com/themes/freelancer/"><i class="fas fa-download mr-2"></i>Free Download!</a></div>
                        </div>
                    </section>
                </div>
            </div>
